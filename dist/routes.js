...
var PerformanceController_1 = __importDefault(require("./controllers/PerformanceController"));
...
/** Performance */
router.put('/performance/totalTasksCompleted', authMiddleware_1.default, PerformanceController_1.default.updateTotalTasksCompleted);
router.put('/performance/totalWorkingTime', authMiddleware_1.default, PerformanceController_1.default.updateTotalWorkingTime);
router.put('/performance/totalRestTime', authMiddleware_1.default, PerformanceController_1.default.updateTotalRestTime);
