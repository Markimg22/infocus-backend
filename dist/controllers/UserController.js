...
var UserController = /** @class */ (function () {
    ...
    UserController.prototype.store = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            var _a, email, password, passwordAgain, userExits, user, e_1;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _b.trys.push([0, 3, , 4]);
                        _a = req.body, email = _a.email, password = _a.password, passwordAgain = _a.passwordAgain;
                    ...
                    case 2:
                        user = _b.sent();
                        return [2 /*return*/, res.json(user.email)];
                    case 3:
                        e_1 = _b.sent();
                        return [2 /*return*/, res.status(400).json({ errors: 'Houve um erro ao registrar usuário.' })];
