...
var PerformanceController = /** @class */ (function () {
    ...
    PerformanceController.prototype.updateTotalTasksCompleted = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        _a.sent();
                        return [2 /*return*/, res.json(user.performance)];
                    case 3:
                        e_1 = _a.sent();
    ...
    PerformanceController.prototype.updateTotalWorkingTime = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            var value, user, e_2;
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    PerformanceController.prototype.updateTotalRestTime = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            var value, user, e_3;
            return __generator(this, function (_a) {
                switch (_a.label) {
